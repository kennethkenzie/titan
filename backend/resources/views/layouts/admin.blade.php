...
<div class="flex min-h-screen">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 flex w-60 flex-col border-r border-white/[0.07] bg-[#0c0c0c]">
        ...
        <nav class="flex-1 overflow-y-auto p-3">
            ...
            @php
                $link = fn(string $routePattern) => request()->routeIs($routePattern)
            ...
            <a href="{{ route('admin.blogs.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.blogs.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.projects.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.projects.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.clients.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.clients.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.479 3 3 0 0 0-4.682-2.72m.94 3.198v-.001c0-.048 0-.095-.001-.143a5.97 5.97 0 0 0-1.106-3.472M15 18.72a8.966 8.966 0 0 1-6 0m6 0a8.966 8.966 0 0 0 6 0m-6 0v-.001c0-.048 0-.095.001-.143a5.97 5.97 0 0 1 1.106-3.472M9 18.72a9.094 9.094 0 0 1-3.742-.479 3 3 0 0 1 4.682-2.72m-.94 3.198v-.001c0-.048 0-.095.001-.143a5.97 5.97 0 0 1 1.106-3.472M15 11.25a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Zm6 3.75a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z"/>
                </svg>
                Clients
            </a>

            <a href="{{ route('admin.services.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.services.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.case-studies.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.case-studies.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.contacts.index') }}"
               class="mb-0.5 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ $link('admin.contacts.*') }}">
                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
